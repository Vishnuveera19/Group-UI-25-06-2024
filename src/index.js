...
import ViewGroupName from "./components/Group UI/ViewGroupName";
import EnterInfos from "./components/Group UI/EnterInfos";
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<App />}>
          ...
          <Route path="/groupui" element={<GroupUi/>}></Route>

          <Route path="/groupui/addinfos" element={<AddInfos/>}></Route>

          <Route path="/groupshift" element={<GroupShift/>}></Route>
